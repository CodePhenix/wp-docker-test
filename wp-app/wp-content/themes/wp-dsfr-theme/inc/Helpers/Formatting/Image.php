<?php
namespace Beapi\Theme\Dsfr\Helpers\Formatting\Image;

/**
 * @usage Beapi\Theme\Dsfr\Helpers\Formatting\Image\get_the_image( 1, [  'data-location' => 'image-size' ] );
 *
...
/**
 * @usage Beapi\Theme\Dsfr\Helpers\Formatting\Image\the_image( 1, [  'data-location' => 'image-size' ], ['before'  => '');
 *
 * @param int $image_id Attachment post ID
 *
 * @param array $attributes {
